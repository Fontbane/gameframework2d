...
typedef struct tile_s {
	...
	Uint8 frames;		/*Number of extra frames of animation this tile has. 0 for none.*/
}TileMetadata;
...
typedef struct tilemap_tile_s {
	PointU8 position;
	Uint16 tileID;
	Uint8 collisionType : 3;	/*User can have up to 8 elevations or collision types*/
	Uint8 above_player : 1;		/*If tile renders above player and other entities*/
